...
import com.example.bitmapfun.R;
import com.example.bitmapfun.provider.Images;
import com.example.bitmapfun.util.ImageCache.ImageCacheParams;
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public ImageAdapter(Context context) {
			...
			if (context.getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
				mActionBarHeight = TypedValue.complexToDimensionPixelSize(tv.data, context.getResources()
						.getDisplayMetrics());
			}
		}
