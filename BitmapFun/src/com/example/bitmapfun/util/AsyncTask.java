 ...
 * {@link #executeOnExecutor(java.util.concurrent.Executor, Object[])} with {@link #THREAD_POOL_EXECUTOR}.
 * </p>
 */
public abstract class AsyncTask<Params, Progress, Result> {
	 ...
	 * particular process.
	 */
	public static final Executor SERIAL_EXECUTOR = Utils.hasHoneycomb() ? new SerialExecutor() : Executors
	 ...
	 *            <tt>true</tt> if the thread executing this task should be interrupted; otherwise, in-progress tasks
	 ...
	 * 
	 * @param exec
	 *            The executor to use. {@link #THREAD_POOL_EXECUTOR} is available as a convenient process-wide thread
